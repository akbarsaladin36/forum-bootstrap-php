...
<body>
    ...
    if($method == 'POST'){
        ...
        if($showAlert){
            echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Selamat!</strong> Komentarmu sudah dimuat.
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
        echo '<div class="container">
                <h1 class="py-2">Kirim Komentarmu</h1>
                <form action="'. $_SERVER['REQUEST_URI'] .'" method="post">
                    <div class="form-group">
                    <label for="text-comment">Isi komentarmu dengan baik dan benar</label>
    ...
    <div class="container" id="ques">
        ...
        if($noResult){
            echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Tidak ada komentar yang tersedia</h1>
                        <p class="lead">Jadilah orang pertama yang berkomentar.</p>
                    </div>
                    </div>';
        }
        ?>
        ...
        <!--<div class="media my-3">
                <img src="img/user-1.png" width="64px;" class="mr-3" alt="...">
                <div class="media-body">
                    <h5 class="mt-0"><a href=thread.php class="text-dark">Halo</a></h5>
                    Test Kata.
            </div>
        </div> -->
